...
export interface ApiUserDetailsUserDetails extends Struct.CollectionTypeSchema {
  collectionName: 'user_details_plural';
  info: {
    displayName: 'UserDetails';
    pluralName: 'user-details-plural';
  ...
  attributes: {
    ...
    constituency: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    position: Schema.Attribute.Enumeration<
      ['Mayor', 'Council Member', 'Representative', 'Senator']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-details.user-details': ApiUserDetailsUserDetails;
